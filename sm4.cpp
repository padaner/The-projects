...
string K[36];
string RK[32];
bitset<32> x0(0x12a3203a);
bitset<32> x1(0xa56f2bc2);
bitset<32> x2(0xa85fed25);
bitset<32> x3(0x1a32c358);
...
int main()
{
	...
	bitset<32> C(c);
	bitset<32> D(d);
	cout << X[35] << endl << A << endl;
	cout << X[34] << endl << B << endl;
	cout << X[33] << endl << C << endl;
	cout << X[32] << endl << D << endl;
}
